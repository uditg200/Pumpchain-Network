...
export const PUMPCHAIN_GAS_LIMIT_PER_BLOCK = 50_000_000;
export const PUMPCHAIN_MAX_TX_SIZE_BYTES = 1232; // Matches Solana MTU
export const PUMPCHAIN_DECIMALS = 9;

export const FAUCET_AMOUNT = 2_000_000_000; // 2 PUMP in lamports (9 decimals)
export const FAUCET_COOLDOWN_MS = 60_000; // 1 minute cooldown
